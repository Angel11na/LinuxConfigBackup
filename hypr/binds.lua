...
-- Video recording
hl.bind(mainMod .. " + F10", hl.dsp.exec_cmd("~/Env/Scripts/toggle-screen-record.sh"))
-- Screen translate
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("~/Env/Scripts/screen-translate.sh"))
...
hl.bind(mainMod .. " + F1",        hl.dsp.exec_cmd("noctalia msg session lock-and-suspend"), { locked = true })

-- Media
hl.bind(           "CTRL + SPACE", hl.dsp.exec_cmd("noctalia msg media toggle"), { locked = true })
hl.bind(           "CTRL + F1",    hl.dsp.exec_cmd("noctalia msg media prev"),   { locked = true })
hl.bind(           "CTRL + F2",    hl.dsp.exec_cmd("noctalia msg media next"),       { locked = true })

-- Panels
hl.bind(mainMod .. " + D",         hl.dsp.exec_cmd("noctalia msg dock-toggle"))
...
hl.bind(mainMod .. " + CTRL + S",  hl.dsp.exec_cmd("noctalia msg screenshot-annotate"))
